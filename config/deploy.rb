...
set :wp_user, "kuzenko" # The admin username
set :wp_email, "kuzenko@gmail.com" # The admin email address
set :wp_sitename, "SLCOM" # The site title
set :wp_localurl, "http://localhost.kk" # Your local environment URL

############################################
# Setup project
############################################

set :application, "wp-sl"
set :repo_url, "git@github.com:kkuzenko/wp-sl.git"
set :scm, :git
